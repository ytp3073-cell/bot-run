...
TOKEN = os.getenv('8577640462:AAF47vgRWAJhp7EX86XJgycSYIvpePBzN4s')
OWNER_ID_STR = os.getenv('8018964088')
ADMIN_ID_STR = os.getenv('8018964088')
YOUR_USERNAME = os.getenv('@BGMI_OWNER00')
UPDATE_CHANNEL = os.getenv('@BGMI_MAIN_LODER')
...
YOUR_USERNAME = YOUR_USERNAME or '@BGMI_OWNER00'
UPDATE_CHANNEL = UPDATE_CHANNEL or 'https://t.me/BGMI_MAIN_LODER'
